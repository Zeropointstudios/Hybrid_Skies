...
public class InputManager : MonoBehaviour {
	...
	//fields
	float clickTime = 0; //counter used to distinguish between a tap click and a hold click
	bool holdingDown = false; //toggle for if mouse is being held down
	...
	void Update ()
	{
		...
		{
			clickTime += 0.1f; //need to change this to time.DeltaTime
		}
