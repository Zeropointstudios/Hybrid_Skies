...
public class MitosisModifier : MonoBehaviour {
	...
	void OnTriggerEnter(Collider other)
	{
		...
		{
			// TODO: use a loop
			mitoteInstance1 = pool.Activate(3, transform.position, Quaternion.identity);
			...
			mitoteInstance2 = pool.Activate(3, transform.position, Quaternion.identity);
			...
			mitoteInstance3 = pool.Activate(3, transform.position, Quaternion.identity);
			...
			mitoteInstance4 = pool.Activate(3, transform.position, Quaternion.identity);
